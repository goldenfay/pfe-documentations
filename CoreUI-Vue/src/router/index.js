...
const ModelsContainer = () => import('@/containers/ModelsContainer')

// Views
const Dashboard = () => import('@/views/Dashboard')
const ModelsList = () => import('@/views/models/ModelsList')
const ModelShow = () => import('@/views/models/ModelShow')
  ...
  return [
    {
      ...
      children: [
        ...
        {
          path: 'creation',
          redirect: 'creation/create-sensor',
          name: 'CreationSensor',
          component: {
            render (c) { return c('router-view') }
          },
        ...
        {
          path: 'mycharts',
          redirect: '/mycharts/statistical-charts',
          name: 'mycharts',
          component: {
            render (c) { return c('router-view') }
          },
