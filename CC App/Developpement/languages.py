translate_dict={
    'This is a developement application to manage crowd counting processes':'Ceci est une application de développement dédiée à la gestion des foules.',
    'Learn More':'Plus d''infos',
    'Close':'Fermer',
    'General Settings':'Paramètres générales',
    'Local': 'Local',
    'Online': 'A distance',
    'Server URL:': 'URL de serveur:',
    'Advanced Settings': 'Paramètres avancées',
    'Model type:':'Type modèle:',
    'Detection models:': 'Modèles de détection',
    'Density map based models:':'Modèles CNN-CC',
    'Mode':'Mode',
    'Footage Selection:':'Sélection de vidéo:',
    'Still images':'Image figée',
    'Footage':'Vidéo',
    'Show graphs:':'Afficher les graphes',
    'Show live graph':'Afficher les graphes',
    'Drag and Drop':'Glissez et déposez',
    'or':'ou',
    'Select Files':'Choisissez des fichiers',
    'Yes':'Oui',
    'No':'Non',
    ...
    'Scene Edition':'Editer la scène',
    'Draw the regions you want to focus on':'Tracez les régions à focaliser sur',
    'Invalid Parameters':'Paramètres invalides',
    'The request contains invalid query parameters.':'La requête reçu contient des paramètres invalides.',
    'Sensor not registred':'Capteur non enregistré',
    'The requested sensor Id does not exist.':'L\'Id du capteur demandé n\'existe pas',
    'Start ':'Commencer',
